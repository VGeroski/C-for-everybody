 ...
 * You will also write a function called list_find() that will return
 * the list node containing the integer value or NULL if the value is not in the list. */
